...
class DrawMap():
    ...
    def __init__(self, world):
        ...
        self.window_y = min(950, max_height)
        self.window_x = None
    ...
    def draw_window_trimmings(self):
        ...
        red = (255, 0, 0)
        top_left = (0, 30)
        text = self.font.render("Deep Learning Theory and Practice Final Project", True, red)
